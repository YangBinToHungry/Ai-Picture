<template>
  ...
  <a-form layout="vertical" :model="formData" @finish="handleSubmit">
    ...
    <a-form-item label="空间级别" name="spaceLevel">
      <a-select v-model:value="formData.spaceLevel" :options="SPACE_LEVEL_OPTIONS" placeholder="请输入空间级别" style="min-width: 180px" allow-clear/>
    </a-form-item>
    <a-form-item>
  ...
  <a-card title="空间级别介绍">
    <a-typography-paragraph>
      * 目前仅支持开通普通版，如需升级空间，请联系<a href="https://yangbinyunqing.cn/" target="_blank">杨斌的博客</a>。
    </a-typography-paragraph>
