...
import com.thinkdifferent.aipicturebackend.model.dto.space.*;
...
public class SpaceController {
     ...
     */
    @PostMapping("/delete")
    public BaseResponse<Boolean> deleteSpace(@RequestBody SpaceUpdateRequest spaceUpdateRequest, HttpServletRequest request) {
        if (spaceUpdateRequest == null || spaceUpdateRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        // 判断是否存在
